...
// Copyright (c) 2015 The Babacoin developers
// Copyright (c) 2015 The Babacoin developers
...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "September 14, 2015 BabaCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        vSeeds.push_back(CDNSSeedData("node.babacoin.org", "node.babacoin.org"));
        vSeeds.push_back(CDNSSeedData("node.babacoin.cf", "node.babacoin.cf"));
        vSeeds.push_back(CDNSSeedData("babacoin.no-ip.org", "babacoin.no-ip.org"));
...
public:
    CTestNetParams() {
       ...
       // }
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        // vSeeds.push_back(CDNSSeedData("babacoin.test", "test.babacoin.org"));
